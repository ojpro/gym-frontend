<template>
  <aside v-show="openSidebar" aria-label="Sidebar"
         class="w-72 dark:bg-gray-800 bg-white"
  >
    <!--    //TODO: use merakiui.com for components -->
    <div class="py-4 px-3 sticky top-0 left-0 bottom-0 h-screen transition  z-10">
      <h2 class="text-center mb-6 font-bold dark:text-white">Dashboard</h2>
      <ul class="space-y-2">
        <li>
        ...
        <li>
          <router-link :to="{name:'dashboard.attendances'}"
                       class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700"
          >
            <svg
        ...
        <li>
          <router-link :to="{name:'dashboard.users'}"
                       class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700"
          >
            <svg
                class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
        ...
        <li>
          <router-link :to="{name:'dashboard.subscriptions'}"
                       class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
            <svg
                class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
...
export default {
  ...
  data() {
    return {
      openSidebar: this.$store.state.openSidebar
    }
  },
  watch: {
